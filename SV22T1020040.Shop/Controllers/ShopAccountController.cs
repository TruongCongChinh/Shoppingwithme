// SV22T1020040.Shop/Controllers/ShopAccountController.cs
...
using SV22T1020040.Shop.Models;
...
namespace SV22T1020040.Shop.Controllers
{
    public class ShopAccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            // Mã hóa mật khẩu
            string hashedPassword =SV22T1020040.Models.CryptHelper.HashMD5(model.Password);
            ...
            TempData["SuccessMessage"] = "Đăng ký thành công! Chào mừng bạn đến với  ChinhShopping.";
            return RedirectToAction("Index", "ShopHome");
        }
