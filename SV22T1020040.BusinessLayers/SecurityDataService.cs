...
using SV22T1020040.DataLayers.Interfaces;
using SV22T1020040.DataLayers.SQLServer;
using SV22T1020040.Models;
using SV22T1020040.Models.Security;

namespace SV22T1020040.BusinessLayers
{
    public static class SecurityDataService
    {
        ...
        {
            // ✅ HASH Ở ĐÂY (DUY NHẤT)
            string hashedPassword = Models.CryptHelper.HashMD5(password);
        ...
        {
            string hashedPassword = Models.CryptHelper.HashMD5(newPassword);
